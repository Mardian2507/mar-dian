import ProjectsIcon from "components/svgs/projectsIcon";
          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1">
              <p className="text-gray-600 py-2 flex items-center">
                <ProjectsIcon className="pr-1" /> Next.JS
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <ProjectsIcon className="pr-1" /> Tailwind
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <ProjectsIcon className="pr-1" /> Javascript
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <ProjectsIcon className="pr-1" /> Next Auth
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <ProjectsIcon className="pr-1" /> Github Auth
              </p>
              <p className="text-gray-600 py-2 flex items-center">
                <ProjectsIcon className="pr-1" /> Google Auth
              </p>
            </div>
          </div>
        </div>
