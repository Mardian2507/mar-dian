export default function Main() {
  return (
    <div>
      <h1 className="text-3xl font-bold underline">this is Main</h1>

      <h2 id="about" className="pt-60">
      ...
      <h2 id="projects" className="pt-60">
